...
from mmdet.core.evaluation import rrc_evaluation_funcs
import importlib
...
def icdar_eval(para_dict=None):
        
    result_dict = rrc_evaluation_funcs.main_evaluation(para_dict, default_evaluation_params,validate_data,evaluate_method)
    return result_dict